    ...
    messages: [
      {
        ...
        content: [
          ...
          "explanation is the single synthesis shown above the foldable source-note details.",
          "When existing note perspectives are provided, explanation must directly compare the notes rather than describe them one by one.",
          "Start with what the notes agree on, then explain the meaningful differences in framing, mechanism, assumptions, examples, or tradeoffs and the takeaway from those differences.",
          "Write one cohesive learner-facing comparison. Do not produce a sequence of note summaries, headings, bullets, or labels such as 'Across notes'.",
          "Use note titles or paths only when needed to make a distinction clear; do not prefix every sentence with a note name.",
          "Do not repeat details that belong in each note's contribution. explanation should contain the comparative insight that only becomes visible by reading the notes together.",
          "If there is only one note perspective, explanation should be a stable concept profile that defines the concept and calls out its most useful distinctions.",
          "If existing concept profiles are provided, preserve the broader concept meaning while updating explanation to include the current note's distinct perspective.",
